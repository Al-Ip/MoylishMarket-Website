 =======================================
|					|
|	Alex Ipsalat_K00229834		|
|	Moylish Market PHP Project	|
|					|
 =======================================
...
(1) Header is dynamic and will display different links depending on what type of user is logged in
    (this was done by if statements)
(2) Home screen
...
NOTE!!
The pagination broke last minute and was unable to get it working again. For previous uploads was working fine.